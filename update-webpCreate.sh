...
echo '👉 If you need to update the dependencies as well, run `bash <(curl -fsSL https://raw.githubusercontent.com/chachwick/webpCreate/main/install-webpCreate.sh)`'
